...
exports.fotokopiRoutes = (req, res) => {
    // Make a get request to /api/users
        axios.get('http://localhost/fotokopi/api/fotokopi')
...
exports.PesananRoutes = (req, res) => {
    ...
    axios.all([
        axios.get('http://localhost/pesanan/api/pesanan'),
        axios.get('http://localhost/fotokopi/api/fotokopi')
    ])
        .then(function(response){
...
exports.OrderRoutes = (req, res) => {
    ...
    axios.all([
        axios.get('http://localhost/fotokopi/show', { params : { id : req.query.id }}),
        axios.get('http://localhost/pesanan/api/pesanan')
    ])
